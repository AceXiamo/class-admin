    ...
    <el-card>
        ...
        <div style="margin-bottom: 20px;">
            ...
            <el-table-column prop="recommendedId" label="被引荐人id" header-align="center" align="center"></el-table-column> -->
                <el-table-column prop="recommenderName" label="引荐人" header-align="center"
                    align="center"></el-table-column>
                <el-table-column prop="recommendedName" label="被引荐人" header-align="center"
                    align="center"></el-table-column>
                <el-table-column prop="type" label="引荐类型" header-align="center" align="center"></el-table-column>
                <el-table-column prop="recommendContent" label="引荐内容" header-align="center"
                    align="center"></el-table-column>
                ...
                <el-table-column label="操作" fixed="right" header-align="center" align="center" width="150">
                    ...
                    <template #default="scope">
                        <el-button v-auth="'module:pz_recommend:update'" type="primary" link
                            @click="recommendAddOrUpdateHandle(scope.row.id)">修改</el-button>
                        <el-button v-auth="'module:pz_recommend:delete'" type="danger" link
                            @click="deleteRecommendHandle(scope.row.id)">删除</el-button>
                    </template>
                </el-table-column>
        ...
        <div style="margin-bottom: 20px;">
			...
			<el-table-column prop="updateTime" label="" header-align="center" align="center"></el-table-column> -->
                <el-table-column label="操作" fixed="right" header-align="center" align="center" width="150">
                    ...
                    <template #default="scope">
                        <el-button v-auth="'module:pz_visit:update'" type="primary" link
                            @click="visitAddOrUpdateHandle(scope.row.id)">修改</el-button>
                        <el-button v-auth="'module:pz_visit:delete'" type="danger" link
                            @click="deleteVisitHandle(scope.row.id)">删除</el-button>
                    </template>
                </el-table-column>
            </el-table>
        </div>
        ...
        <div style="margin-bottom: 20px;">
            ...
            <el-table :data="state.eventList" border style="width: 100%">
                ...
                <el-table-column label="操作" fixed="right" header-align="center" align="center" width="150">
                    ...
                    <template #default="scope">
                        <el-button v-auth="'module:pz_recommend:update'" type="primary" link
                            @click="eventAddOrUpdateHandle(scope.row.id)">修改</el-button>
                        <el-button v-auth="'module:pz_recommend:delete'" type="danger" link
                            @click="deleteEventHandle(scope.row.id)">删除</el-button>
                    </template>
                </el-table-column>
            </el-table>
        </div>
        ...
        <div style="margin-bottom: 20px;">
			...
			<el-table-column prop="college" label="用户大学/年级/专业" header-align="center" align="center"></el-table-column> -->
                ...
                <el-table-column label="操作" fixed="right" header-align="center" align="center" width="150">
                    <template #default="scope">
                        <el-button v-auth="'module:pz_recommend:update'" type="primary" link
                            @click="userInfoAddOrUpdateHandle(scope.row.id)">修改</el-button>
                        <el-button v-auth="'module:pz_recommend:delete'" type="danger" link
                            @click="deleteUserInfoHandle(scope.row.id)">删除</el-button>
                    </template>
                </el-table-column>
...
const receivedRecommendList = computed(() => {
    return state.recommendList.filter((item) => { return item.recommendedId == route.query.id })
})
// 给出的引荐记录
const givenRecommendList = computed(() => {
    return state.recommendList.filter((item) => { return item.recommenderId == route.query.id })
})
